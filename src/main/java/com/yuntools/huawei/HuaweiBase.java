...
public class HuaweiBase {
	 ...
	 * 表格文字识别(异步接口)
	 */
	protected static final String FORM_OCR_URL = PropertiesUtil.getPropertiesValue("baidu.form.ocr.url");

	/**
	 * 表格文字识别(异步接口)-获取结果接口
	 */
	protected static final String FORM_OCR_RESULT_URL = PropertiesUtil.getPropertiesValue("baidu.form.ocr.result.url");

	/**
	 * 表格文字识别(同步接口)
	 */
	protected static final String FORM_SYNC_URL = PropertiesUtil.getPropertiesValue("baidu.form.sync.url");

	/**
	 * 数字识别
	 */
	protected static final String NUMBERS_URL = PropertiesUtil.getPropertiesValue("baidu.numbers.url");

	/**
	 * 二维码识别
	 */
	protected static final String QR_CODE_URL = PropertiesUtil.getPropertiesValue("baidu.qr.code.url");

	/**
	 * 印章检测
	 */
	protected static final String SEAL_URL = PropertiesUtil.getPropertiesValue("baidu.seal.url");
	 ...
	 * @param baiDuBaseData
	 */
	public HuaweiBase(BaiDuBaseData baiDuBaseData) {
